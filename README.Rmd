...
* Comes with a [Positron](https://positron.posit.co/) compatible
  [VS Code](https://code.visualstudio.com/) extension.
* Compatible with the [Coverage Gutters](
    https://marketplace.visualstudio.com/items?itemName=ryanluker.vscode-coverage-gutters)
  VS Code extension, also in [Positron](
    https://open-vsx.org/extension/ryanluker/vscode-coverage-gutters).
...
* HTML report, including a summary table and detailed reports for all files.
